  ...
  return (
    <div className="min-h-screen font-sans bg-[#020617] text-slate-200 selection:bg-gold-500 selection:text-black">
      ...
      <main>
        ...
        <section id="about" className="py-40 relative overflow-hidden">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-8 glass p-16 md:p-24 relative overflow-hidden group">
                ...
                <h2 className="text-5xl md:text-8xl font-display font-bold mb-12 text-white leading-[0.85] tracking-tighter uppercase">ЗАЩИТА С <br/><span className="golden-text">ХАРАКТЕРОМ</span></h2>
                <p className="max-w-3xl text-slate-400 text-xl font-light leading-relaxed mb-16">
                ...
                <div className="flex flex-wrap gap-16">
                  <div>
                    <span className="block text-5xl font-display font-bold text-white mb-3 tracking-tighter">25+</span>
                    <span className="text-[10px] uppercase tracking-[0.3em] text-slate-600">Лет практики</span>
                  </div>
                  <div>
                    <span className="block text-5xl font-display font-bold text-white mb-3 tracking-tighter">5к+</span>
                    <span className="text-[10px] uppercase tracking-[0.3em] text-slate-600">Клиентов</span>
                  </div>
                  <div>
                    <span className="block text-5xl font-display font-bold text-white mb-3 tracking-tighter">92%</span>
                    <span className="text-[10px] uppercase tracking-[0.3em] text-slate-600">Выигрыш дел</span>
                  </div>
                </div>
              </div>

              <div className="lg:col-span-4 bg-gold-600 p-16 flex flex-col justify-between group cursor-default">
                <div className="space-y-10">
                   ...
                   <h3 className="text-3xl font-display font-bold text-white uppercase tracking-tighter leading-none">Комплексная броня</h3>
                </div>
                <div>
        ...
        {/* Services Grid */}
        <section id="services" className="py-40 bg-slate-950/40">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-32 gap-12">
              <div className="max-w-4xl">
                ...
                <h2 className="text-6xl md:text-9xl font-display font-black text-white uppercase leading-[0.8] tracking-tighter">ЛИНИЯ <br /><span className="text-outline">ОБОРОНЫ</span></h2>
              </div>
        ...
        {/* Big CTA */}
        <section id="contact" className="py-48 relative bg-slate-950 overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center opacity-[0.02] pointer-events-none select-none">
             <span className="text-[25vw] font-display font-black whitespace-nowrap">ISLAND LAW</span>
          </div>
          <div className="container mx-auto px-6 text-center relative z-10">
            <h2 className="text-6xl md:text-[11rem] font-display font-black text-white mb-20 leading-none tracking-tighter uppercase">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-16">
               <div className="flex flex-col items-center">
                  ...
                  <a href="tel:+79089788919" className="text-4xl md:text-7xl font-display font-bold text-white hover:text-gold-500 transition-all tracking-tighter underline underline-offset-[16px] decoration-gold-500/20">
                    +7 (908) 978-89-19
                  </a>
               </div>
               ...
               <div className="flex flex-col items-center">
                  ...
                  <a 
                    ...
                    target="_blank"
                    className="px-16 py-8 bg-green-600 text-white font-display font-bold uppercase tracking-[0.2em] text-[11px] hover:bg-green-500 transition-all shadow-2xl shadow-green-600/20"
                  >
      ...
      <footer className="bg-[#01040f] py-40 border-t border-white/5 relative">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 mb-32">
            <div className="lg:col-span-6">
              <span className="text-4xl font-display font-bold tracking-tighter text-white block mb-12">ИСЛАНД <span className="text-gold-500 italic">ВОСТОК</span></span>
          ...
          <div className="pt-24 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12">
            <p className="text-slate-800 text-[10px] font-display uppercase tracking-[0.6em]">© 2025 ISLAND VOSTOK LAW. SINCE 2000.</p>
            <div className="flex gap-16 text-[10px] text-slate-800 uppercase tracking-widest">
